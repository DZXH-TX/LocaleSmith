...
public sealed class CliConfirmationViewModel : ViewModelBase, IDisposable
{
    ...
    private readonly JaxI18n.Presentation.Abstractions.IUiTextProvider _text;
    ...
    public CliConfirmationViewModel(
        ...
        string auditLogPath,
        JaxI18n.Presentation.Abstractions.IUiTextProvider? text = null)
    {
        _command = command ?? throw new ArgumentNullException(nameof(command));
        _policy = policy ?? throw new ArgumentNullException(nameof(policy));
        _approvalService = approvalService ?? throw new ArgumentNullException(nameof(approvalService));
        _runner = runner ?? throw new ArgumentNullException(nameof(runner));
        _text = text ?? JaxI18n.Presentation.Abstractions.FallbackUiTextProvider.Instance;
